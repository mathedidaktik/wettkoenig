    ...
    <div id="x-top-level-container" class="flex h-full w-full flex-wrap flex-row justify-between">
        <div id="y-dice-control-container" class="flex flex-col grow w-full lg:w-1/5 xl:w-1/5 p-4">
            ...
            <div id="x-dices-container" class="flex flex-row space-x-4 mt-1">
                <div class="y-dice-container flex flex-col grow">
                ...
                <div class="y-dice-container flex flex-col grow" v-if="secondDice">
...
export default{
            ...
            return {
                ...
                chartData: {
                    ...
                    datasets: [
                    {
                        //axis: 'y',
                        label: 'Würfel 1',
                        backgroundColor: ['rgba(230, 51, 42, 0.2)', 'rgba(255, 204, 0, 0.2)', 'rgba(0,53,96, 0.2)'],
                        borderColor: ['rgb(230, 51, 42)', 'rgb(255, 204, 0)', 'rgb(0,53,96)'],
                        borderWidth: 1,
                        data: [0, 0, 0],
                    },
                    {
                        //axis: 'y',
                        label: 'Würfel 2',
                        backgroundColor: ['rgba(230, 51, 42, 0.4)', 'rgba(255, 204, 0, 0.4)', 'rgba(0,53,96, 0.4)'],
                        borderColor: ['rgb(230, 51, 42)', 'rgb(255, 204, 0)', 'rgb(0,53,96)'],
                        borderWidth: 1,
                        data: [0, 0, 0],
                    },
        ...
        methods: {
            ...
            setTableToZero(diceId) {
                if (diceId == 0) {
                    this.myChart.data.datasets[0].data = [0, 0, 0];
                    this.myChart.update();
                }
                else if (diceId == 1) {
                    this.myChart.data.datasets[1].data = [0, 0, 0];
                    this.myChart.update();
                }
            },
